...
export default function FindLoseAccountByMatchId() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await adminService.findLostAccountByMatchId(matchId);
...
<>
        ...
        {isPopupOpen ? 'Cancel' : 'Find Lose Account'}
      </button>
      {isPopupOpen && (
        <div className="popup">
